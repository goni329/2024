document.addEventListener('DOMContentLoaded', () => {
  ...
  function handleSearch() {
    ...
    const result = rowData.find(row => row.지역 === keyword); // 지역과 검색어가 일치하는지
